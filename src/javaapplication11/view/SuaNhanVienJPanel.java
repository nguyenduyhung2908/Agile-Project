 ...
 */
public class SuaNhanVienJPanel extends javax.swing.JFrame {
    ...
    public SuaNhanVienJPanel(int id) {
        this.id = id;
        initComponents();
    ...
    public void fillTextField(Employees e){
        ...
        cbxRole.setSelectedIndex(e.getRole()-1);
        if(e.getGender() == 1){
            radMale.setSelected(true);
        }else{
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(e != null){
            ...
            if(confirm == JOptionPane.YES_OPTION){
                boolean isUpdated = this.service.updateEmployees(e);
                if(isUpdated){
